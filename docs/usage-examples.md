...
def submit_maxcut_problem():
    """
    MaxCut test script that matches the actual API implementation.
...
def test_system_and_execute():
    ...
    print("\n=== System Statistics ===")
    response = requests.get("http://localhost:8000/api/v1/system/stats")
    stats = response.json()
    ...
    print("\n=== Edge Profiles ===")
    response = requests.get("http://localhost:8000/api/v1/config/edge-profiles")
